                    ...
                    <div key={item?.card?.info?.id}>
                        ...
                        <li className=" flex   justify-between   my-2  duration-200 transition-all">
                            ...
                            <div className="relative">
                                <div className="w-36 h-30 rounded-md">
                                <img className=" object-cover  w-36 h-30 rounded-md overflow-hidden " src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/" + item.card.info.imageId} alt="" />

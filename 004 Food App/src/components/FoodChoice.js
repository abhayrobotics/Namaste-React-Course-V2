  ...
  return (
    <>
      <div className="  w-9/12 m-auto  ">
        ...
        <div className="font-bold text-2xl mb-2 leading-6">What's on your mind ?</div>
        {/* Banner Food Choice */}
        <div className="flex">
          <div className="w-8 mr-2  rounded-3xl bg-slate-200 p-2 cursor-pointer" onClick={leftScroll} >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 288 480 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-370.7 0 73.4-73.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-128 128z" />
            </svg>
          </div>
          <div className="w-8 rounded-3xl bg-slate-200 p-2 cursor-pointer" onClick={rightScroll}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div className=" flex  overflow-scroll overflow-y-hidden  scroll-smooth " id="banner-slider">
          {foodList?.map((item) => {
